    ...
    <div class="content_middle">
     ...
     <form method="get" class="admin_form fl" action="<?php echo PATH.$this->url;?>">
        ...
        <table class="list_table fl clr mt20">
			...
			<th align="left" width="20%"><div class="arrow"><a href="<?php echo $this->sort_url;?>param=name&sort=<?php if($this->input->get('sort')=='DESC'){ echo 'ASC'; }else{ echo 'DESC'; } ?>" title="<?php echo $this->Lang['SORT_BY_PROD_NA']; ?>" ><?php echo $this->Lang["PRODUCT_NAME"]; ?></a></div></th>
			...
			<th align="left" width="15%"><div class="arrow4"><a href="<?php echo $this->sort_url;?>param=value&sort=<?php if($this->input->get('sort')=='DESC'){ echo 'ASC'; }else{ echo 'DESC'; } ?>" title="<?php echo $this->Lang['SO_B_PROD_VAL']; ?>" ><?php echo $this->Lang["DEALVALUE"]; ?><?php echo '('.CURRENCY_SYMBOL.')';?></a></div></th>
		<?php /*
			<th align="left" width="15%"><div class="arrow5"><a href="<?php echo $this->sort_url;?>param=savings&sort=<?php if($this->input->get('sort')=='DESC'){ echo 'ASC'; }else{ echo 'DESC'; } ?>" title="<?php echo $this->Lang['SO_B_PROD_SAVE']; ?>" ><?php echo $this->Lang["SAVINGS"]; ?><?php echo '('.CURRENCY_SYMBOL.')';?></a></div></th>
			*/ ?>
			<th align="left" width="15%"><?php echo $this->Lang["PRODUCT_IMG"]; ?></th>
			<th align="left" width="15%"><?php echo $this->Lang["CREATED_DATE"]; ?></th>
			<?php if(($this->uri->last_segment() == 'manage-products.html')||($this->uri->segment(2) == 'manage-products.html')){ ?> <th align="left" ><?php echo $this->Lang['SEND_MAIL']; ?></th> <?php //} ?>
		...
		<?php } ?>
			...
			foreach($this->all_product_list as $u){?>
		     ...
		     <?php /*
	             ...
	             { ?>
                    <td align="left"><img border="0" src= "<?php echo PATH.'resize.php';?>?src=<?php echo PATH.'images/products/1000_800/'.$u->deal_key.'_1'.'.png';?>&w=80&h=80" alt="" /></td>
                     <?php } else { ?>
                  ...
                  <?php if(($this->uri->last_segment() == 'manage-products.html')||($this->uri->segment(2) == 'manage-products.html') && ($u->deal_status == 1) ){ ?>
                   <?php if($u->deal_status == 1){ ?>
			        <td>
		        <a title="Email to register users" href="<?php echo PATH.'merchant/send-product/'.$u->deal_id.'/'.$u->deal_key.'.html';?>"><img src="<?php echo PATH;?>images/mail.png"></a></td> <?php } else{ echo "<td>---</td>"; }?>
		        <?php } ?>
			<?php if(($this->uri->last_segment() == 'manage-products.html')||($this->uri->segment(2) == 'manage-products.html')){ ?> 
                    <td align="left">
                    <a href="<?php echo PATH.'merchant/edit-products/'.base64_encode($u->deal_id).'/'.$u->deal_key.'/'.base64_encode('edit').'.html';?>" class="editicon" title="<?php echo $this->Lang['EDIT_PRODUCT']; ?>"></a>
                    </td>
          <?php } ?>
					<td align="left">
                    <a href="<?php echo PATH.$u->store_url_title.'/product/'.$u->deal_key.'/'.$u->url_title.'/merchant-manage-preview.html';?>" class="previewicon" title="<?php echo $this->Lang['PREVIEW']; ?>" target="_blank"></a>
                    </td>
                    <?php /* if(($this->uri->last_segment() == 'manage-products.html')||($this->uri->segment(2) == 'manage-products.html')){ ?> 
                    <td align="left">
                    <?php if($u->deal_status == 1){?>
