        ...
        <table class="list_table fl clr mt20">
			...
			//	$saving = round((($u->product_value - $u->deal_value) / $u->product_value) * 100) ;
                ...
                <tr>    
                        ...
                        <td align="left"><a href="<?php echo PATH.'merchant/view-auction/'.$u->deal_key.'/'.$u->deal_id.'.html';?>" title="<?php echo $u->deal_title; ?>"><?php echo htmlspecialchars($u->deal_title); ?> </td>
