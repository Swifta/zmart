    ...
    <div class="date_range_common">            
        ...
        <div class="date_range_bottm" >    
            ...
            <?php   if(isset($this->end_date)){  ?>    
                <input class="search_cancel" type="button" value="<?php echo $this->Lang['CANCEL']; ?>" onclick='window.location.href="<?php echo PATH?>merchant/products-dashboard.html"'/>                    
            <?php } ?>
             </div>
        </div>
    </div>
        ...
        <div class="inves_marketing">
		 ...
		 <p class="clearfix"> <span><?php echo $this->Lang["TOT_PRO_CUNT"]; ?> </span> <span class="right_1">  <?php echo $c["active_products"]+$c["archive_products"];?></span></p>
                ...
                <div class="prcess_bar3">
                 ...
                 <p class="clearfix">
		    <span><a href="<?php  echo PATH; ?>merchant/manage-products.html"><?php echo $this->Lang['ACTIVE_PRODUCTS']; ?> <?php echo $this->Lang['COUNT']; ?> </a></span>
			...
			<?php $act_tot=""; if(($c["active_products"]!=0)||($c["archive_products"]!=0)){$act_tot= ($c["active_products"]/($c["active_products"]+$c["archive_products"]))*100;  }?>
                ...
                <p class="clearfix">
            <span><a href="<?php  echo PATH; ?>merchant/sold-products.html"><?php echo $this->Lang['SOLD_PRODUCTS']; ?> <?php echo $this->Lang['COUNT']; ?> </a></span>
