        ...
        <form method="post" class="admin_form" name="edit_users" enctype="multipart/form-data">
                <table>
	                ...
	                <?php } }  ?> 
                        ...
                        <tr>
                                ...
                                <td><label>:</label></td>
                                <td><input type="text" name="zipcode" maxlength="8" value="<?php echo $u->zipcode;?>"/>
			...
			<tr >
                        ...
                        <tr>
                                ...
                                <td><input type="submit" value="<?php echo $this->Lang['SUBMIT']; ?>" id="check2"/><a href="<?php echo PATH?>merchant/manage-shop.html"><input type="button" value="<?php echo $this->Lang['CANCEL']; ?>"/></a></td>
                        </tr>
                </table>
        </form>
          <?php  }?>
