...
<div class="cont_container mt15 mt10">
    ...
    <legend><?php echo $this->Lang['AUC_PRO_DETAILS']; ?></legend>
		...
		<a class="fr" style="float:right;text-decoration: underline; cursor: pointer;position:relative; z-index:2;" href="<?php echo PATH.'merchant/view-auction/'.$this->auction_key.'/'.$this->auction_id.'.html?id='.$this->Lang['SEARCH'];  ?>" title="<?php echo $this->Lang['EXPO_BIDD_LI']; ?>"><img src="<?php echo PATH ?>images/csv.png" class="image" alt="<?php echo $this->Lang['EXPO_BIDD_LI']; ?>"/></a>
		<?php } } ?>
...
<div class="mergent_det2">
      ...
      <legend> <?php echo $this->Lang['TRANS_DET']; ?></legend>
               <table> 
                <tr> 
                <td colspan="3"> <?php echo new View("merchant/biding_transaction_list"); ?></td>
                </tr> 
