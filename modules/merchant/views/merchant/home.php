    ...
    <?php  /*<div class="merchant_home">
        ...
        <div class="merchant_home_content">
            <ul>
                ...
                <li>
                    <div class="lft_bg">
                        <a href="<?php echo PATH; ?>merchant/shipping-delivery.html"><img src="<?php echo PATH;?>/images/new_8.png"/></a>
                    </div>
                    <div class="new_rgt_con">
                        <strong>Allow Installment Payment</strong>
                        <a href="<?php echo PATH; ?>merchant/shipping-delivery.html">Allow Installment Payment</a>
                    </div>
                </li>
                <li>
                    <div class="lft_bg">
                        <a href="<?php echo PATH; ?>merchant/all-transaction.html"><img src="<?php echo PATH;?>/images/new_9.png"/></a>
                    </div>
                    <div class="new_rgt_con">
                        <strong>View all Orders</strong>
                        <a href="<?php echo PATH; ?>merchant/all-transaction.html">View all Orders</a>
                    </div>
                </li>
                <li>
                    <div class="lft_bg">
