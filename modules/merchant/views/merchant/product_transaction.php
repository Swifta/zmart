...
<div class="cont_container mt15 mt10">
	...
	<table class="list_table1 fl clr">
        ...
        <div class="date_range_common">            
		        ...
		        <option value="<?php echo PATH.'merchant-product/all-transaction.html';?>" <?php if($this->uri->last_segment() == "all-transaction.html"){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["ALL_TRAN"]; ?></option>
		        ...
		        <option value="<?php echo PATH.'merchant-product/completed-transaction.html';?>" <?php if(($this->uri->last_segment() == "completed-transaction.html")||($this->uri->segment(2)== "completed-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["COMP_TRAN"]; ?></option>
	...
	<?php echo new View("merchant/product_transaction_list"); ?>
    </div>
