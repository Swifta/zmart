    ...
    <div class="content_middle">
        ...
        <form action="" method="post" class="admin_form"  enctype="multipart/form-data">
			...
			<tr>
                    ...
                    <td>
                        <select autofocus name="sector" class="required" onchange="return merchant_change_sector(this.value);">
			    
                        <?php if($uu->store_sector_id != ''){ ?>
                        <?php if($uu->store_sector_id == 0){?>
			<option value="0" <?php if($uu->store_sector_id == 0){?> selected="selected" <?php } ?>><?php echo "Default"; ?></option> 
			<?php } ?>
