        ...
        <form method="post"  class="admin_form" enctype="multipart/form-data">
                <table>                       
                         <tr>
                                ...
                                <td><label>:</label></td>
                                <td><input type="text" name="storename" maxlength="255" value="<?php if(!isset($this->form_error['storename']) && isset($this->userPost['storename'])){echo $this->userPost['storename'];}?>" autofocus />
			 ...
			 <tr>
                    ...
                    <td>
                        ...
                        <tr>
                                <td></td>
                                <td></td>
                                <td><input type="submit" id="submit" value="<?php echo $this->Lang['SUBMIT']; ?>" /><input type="button" value="<?php echo $this->Lang['RESET']; ?>" onclick="javascript:window.location='<?php echo PATH; ?>merchant/add-shop.html'"/></td>
                        </tr>
                </table>
        </form>
    </div>
