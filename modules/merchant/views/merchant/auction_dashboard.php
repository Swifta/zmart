    ...
    <div class="date_range_common">            
        ...
        <div class="date_range_bottm" >    
            ...
            <?php   if(isset($this->end_date)){  ?>    
                <input class="search_cancel" type="button" value="<?php echo $this->Lang['CANCEL']; ?>" onclick='window.location.href="<?php echo PATH?>merchant/auction-dashboard.html"'/>                         
            <?php } ?>
             </div>
        </div>
    </div>
          ...
          <div class="invest-cl">
            <div class="invest-cr">
              <div class="invest-cm">
                ...
                <p class="clearfix"> <span><a href="<?php  echo PATH; ?>merchant/manage-deals.html">Active Auction <?php echo $this->Lang['COUNT']; ?> </a></span> <span class="right_1"> <?php echo $c["active_auction"]?></span> </p>
                ...
                <p class="clearfix"> <span><a href="<?php  echo PATH; ?>merchant/archive-deals.html">Archive Auction <?php echo $this->Lang['COUNT']; ?> </a></span> <span class="right_1"> <?php echo $c["archive_auction"];?></span> </p>
