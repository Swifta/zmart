    ...
    <div class="date_range_common">            
        ...
        <div class="date_range_bottm" >    
            ...
            <?php   if(isset($this->end_date)){  ?>    
                <input class="search_cancel" type="button" value="<?php echo $this->Lang['CANCEL']; ?>" onclick='window.location.href="<?php echo PATH?>merchant/deals-dashboard.html"'/>
            <?php } ?>
             </div>
        </div>
    </div>
          ...
          <div class="invest-cl">
            <div class="invest-cr">
              <div class="invest-cm">
                ...
                <p class="clearfix"> <span><a href="<?php  echo PATH; ?>admin/manage-deals.html"><?php echo $this->Lang['ACTIVE_DEALS']; ?> <?php echo $this->Lang['COUNT']; ?> </a></span> <span class="right_1"> <?php echo $c["active_deals"]?></span> </p>
                ...
                <p class="clearfix"> <span><a href="<?php  echo PATH; ?>admin/archive-deals.html"><?php echo $this->Lang['ARCHIVE_DEALS']; ?> <?php echo $this->Lang['COUNT']; ?> </a></span> <span class="right_1"> <?php echo $c["archive_deals"];?></span> </p>
