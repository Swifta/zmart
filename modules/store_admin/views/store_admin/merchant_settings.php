...
<div class="cont_container mt15 mt10">
    ...
    <div class="content_middle">
     <div class="settings_menu">
        <ul>
            <li><a href="<?php echo PATH.'store-admin/Edit_info.html'; ?>"><?php echo $this->Lang["EDIT_INFO"]; ?> </a></li><li>|</li>
            <li><a href="<?php echo PATH.'store-admin/change_password.html'; ?>"><?php echo $this->Lang["CHANGE_PASS"]; ?></a></li>
        </ul>
    </div>
