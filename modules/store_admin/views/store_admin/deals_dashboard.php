...
<form class="admin_form" action="" method="get" >
    <label> <b class="search_deal_title"><?php echo $this->Lang['SRCH_DL_TRANS']; ?> : </b></label>
    ...
    <div class="date_range_common">            
        ...
        <div class="date_range_bottm" >    
            ...
            <?php   if(isset($this->end_date)){  ?>    
                <input class="search_cancel" type="button" value="<?php echo $this->Lang['CANCEL']; ?>" onclick='window.location.href="<?php echo PATH?>store-admin/deals-dashboard.html"'/>
            <?php } ?>
             </div>
        </div>
    </div>
    ...
    if(count($this->deals_transaction_list)>0){       
        ...
        for($i=0;$i<7;$i++)
                ...
                foreach($this->deals_transaction_list as $transaction){
                        ...
                        if(($start <= $transactiondate) && ( $end >= $transactiondate)) {
                            if($transaction->deal_type==2){
                               $wpa +=$transaction->deal_value;
                               $wpc +=1;  
                            } else { 
                               $wda +=$transaction->deal_value;
                               $wdc +=1; 
                            }
...
Highcharts.theme = {
   colors: ['#ff9b02', '#50B432', '#DDDF00', '#24CBE5', '#64E572', '#FF9655', '#FFF263', '#6AF9C4'],
   chart: {
      backgroundColor: {
...
$(function () {
    ...
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            title: {
                text: '<?php echo $this->Lang['TOT_DL_CUNT']; ?>'
            },
    
            xAxis: {
                categories: ['<?php echo $this->Lang['DL_CUNT']; ?>']
            },
            ...
            yAxis: {
                ...
                min: 0,
                title: {
                    text: '<?php echo $this->Lang['NUM_OF_DLS']; ?>'
                }
            ...
            series: [ {
                name: '<?php echo $this->Lang['ACTIVE_DEALS']; ?>',
                data: [<?php echo $c["active_deals"]?>],
                stack: 'male'
            },{
                name: '<?php echo $this->Lang['ARCHIVE_DEALS']; ?>',
                data: [<?php echo $c["archive_deals"]?>],
                stack: 'male'
            }]
        });
    });
      ...
      <div class="invest-cr">
        <div class="inves_marketing">
          ...
          <div class="invest-cl">
            <div class="invest-cr">
              <div class="invest-cm">
                <p class="clearfix"> <span><?php echo $this->Lang['TOT_DL_CUNT']; ?> </span> <span class="right_1"> <?php echo $c["active_deals"]+$c["archive_deals"];?></span> </p>
                <div class="prcess_bar3">
                  <div class="pro_left"></div>
                  <div class="pro_mid" style="width:95%"> </div>
                  <div class="pro_rgt"> </div>
                </div>
                <p class="clearfix"> <span><a href="<?php  echo PATH; ?>store-admin/manage-deals.html"><?php echo $this->Lang['ACTIVE_DEALS']; ?> <?php echo $this->Lang['COUNT']; ?> </a></span> <span class="right_1"> <?php echo $c["active_deals"]?></span> </p>
                <div class="prcess_bar1">
                  <?php $act_tot=""; if(($c["active_deals"]!=0)||($c["archive_deals"]!=0)){$act_tot= ($c["active_deals"]/($c["active_deals"]+$c["archive_deals"]))*100;}  ?>
                  <?php  if($act_tot){?>
                  <div class="pro_left"></div>
                ...
                <p class="clearfix"> <span><a href="<?php  echo PATH; ?>store-admin/archive-deals.html"><?php echo $this->Lang['ARCHIVE_DEALS']; ?> <?php echo $this->Lang['COUNT']; ?> </a></span> <span class="right_1"> <?php echo $c["archive_deals"];?></span> </p>
                <div class="prcess_bar2">
                  <?php $arc_tot= ""; if(($c["active_deals"]!=0)||($c["archive_deals"]!=0)){$arc_tot= ($c["archive_deals"]/($c["active_deals"]+$c["archive_deals"]))*100; }?>
                  <?php  if($arc_tot){?>
                  <div class="pro_left"></div>
