    ...
    <div class="date_range_common">            
        ...
        <div class="date_range_bottm" >    
            ...
            <?php   if(isset($this->end_date)){  ?>    
                <input class="search_cancel" type="button" value="<?php echo $this->Lang['CANCEL']; ?>" onclick='window.location.href="<?php echo PATH?>store-admin/transaction-dashboard.html"'/>                    
            <?php } ?>
             </div>
        </div>
    </div>
