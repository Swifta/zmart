    ...
    <div class="content_middle">
        ...
        <form action="" method="post" class="admin_form">
            <table>
                ...
                <tr><td><label><input type="radio" <?php if($d->terms_conditions_status == 1){ ?> checked  <?php } ?> name="terms_conditions_status" value="1"><?php echo $this->Lang['ACTIVE1']; ?></label><label><input type="radio" <?php if($d->terms_conditions_status == 0){ ?> checked  <?php } ?> name="terms_conditions_status" value="0" ><?php echo $this->Lang['DEACTIVE']; ?></label></td></tr>
                <tr><td><label><?php echo $this->template->title; ?> :</label><em><?php if(isset($this->form_error["terms_conditions"])){ echo $this->form_error["terms_conditions"]; }?></em></td></tr>
                <tr><td><textarea autofocus name="terms_conditions" class="TextArea" ><?php echo $d->terms_conditions; ?></textarea></td></tr>
