...
<div class="cont_container mt15 mt10">
    ...
    <div class="content_middle">
     ...
     <form method="get" class="admin_form" action="<?php echo PATH.$this->url;?>">
		...
		<?php  if(($this->uri->last_segment() == 'store-admin-deals.html') || ($this->uri->last_segment() == 'store-admin-deals.html') ||($this->uri->segment(3))){
			...
			foreach($this->all_deal_list as $u){?>
		     ...
		     <td align="left"><?php echo $u->deal_value; ?></td>
	             ...
	             { ?>
                  ...
                  <td align="left">
                    <a href="<?php echo PATH.'store-admin/edit-deal/'.base64_encode($u->deal_id).'/'.$u->deal_key.'.html';?>" class="editicon" title="<?php echo $this->Lang['EDIT_DEAL']; ?>"></a>
                    </td>
                    <?php } ?>
					<td align="left">
                  ...
                  <?php } */ ?>
                    <td align="left"><a href="<?php echo PATH.'store-admin/view-deal/'.$u->deal_key.'/'.$u->deal_id.'.html';?>"><?php echo $this->Lang["VIEW_DET"]; ?></a></td>
                </tr>
            <?php $i++;} ?>   
        </table> 
		</div>
