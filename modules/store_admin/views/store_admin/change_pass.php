    ...
    <div class="content_middle">
        ...
        <form action="" method="post" class="admin_form">
            <table>
                ...
                <td><input name="cpassword" type="password" value="" size="30" placeholder="<?php echo $this->Lang["CONFIRM_PASS"]; ?>" /><em><?php if(isset($this->form_error['cpassword'])){ echo $this->form_error["cpassword"]; }?></td>
                 <tr>
                 <td></td>
                  <td><input type="submit" value="<?php echo $this->Lang['UPDATE']; ?>" /><input type="button" value="<?php echo $this->Lang['CANCEL']; ?>" onclick='window.location.href="<?php echo PATH?>store-admin/settings.html"'/></td>
                </tr>
             </table>
        </form>
