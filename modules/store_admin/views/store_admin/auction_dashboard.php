...
<form class="admin_form"  action="" method="get">
    <label> <b class="search_deal_title"><?php echo $this->Lang['SRCH_AUC_TRANS']; ?> : </b></label>
    ...
    <div class="date_range_common">            
        ...
        <div class="date_range_bottm" >    
            ...
            <?php   if(isset($this->end_date)){  ?>    
                <input class="search_cancel" type="button" value="<?php echo $this->Lang['CANCEL']; ?>" onclick='window.location.href="<?php echo PATH?>store-admin/auction-dashboard.html"'/>                         
            <?php } ?>
             </div>
        </div>
    </div>
      ...
      <div class="invest-cr">
        <div class="inves_marketing">
          ...
          <div class="invest-cl">
            <div class="invest-cr">
              <div class="invest-cm">
                <p class="clearfix"> <span>Total Auction Count </span> <span class="right_1"> <?php echo $c["active_auction"]+$c["archive_auction"];?></span> </p>
                ...
                <p class="clearfix"> <span><a href="<?php  echo PATH; ?>store-admin/manage-auction.html">Active Auction <?php echo $this->Lang['COUNT']; ?> </a></span> <span class="right_1"> <?php echo $c["active_auction"]?></span> </p>
                ...
                <p class="clearfix"> <span><a href="<?php  echo PATH; ?>store-admin/archive-auction.html">Archive Auction <?php echo $this->Lang['COUNT']; ?> </a></span> <span class="right_1"> <?php echo $c["archive_auction"];?></span> </p>
