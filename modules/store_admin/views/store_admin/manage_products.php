...
<div class="cont_container mt15 mt10">
    ...
    <div class="content_middle">
     ...
     <form method="get" class="admin_form fl" action="<?php echo PATH.$this->url;?>">
		...
		<?php  if(($this->uri->last_segment() == 'store-admin/mange-products.html') || ($this->uri->last_segment()=='store-admin/sold-products.html') || ($this->uri->segment(3))){			
		...
		<?php } ?>
			...
			<?php if(($this->uri->last_segment() == 'manage-products.html')||($this->uri->segment(2) == 'manage-products.html')){ ?> 
                    <td align="left">
                    <a href="<?php echo PATH.'store-admin/edit-products/'.base64_encode($u->deal_id).'/'.$u->deal_key.'/'.base64_encode('edit').'.html';?>" class="editicon" title="<?php echo $this->Lang['EDIT_PRODUCT']; ?>"></a>
                    </td>
          <?php } ?>
					<td align="left">
                    <a href="<?php echo PATH.$u->store_url_title.'/product/'.$u->deal_key.'/'.$u->url_title.'/store-admin-manage-preview.html';?>" class="previewicon" title="<?php echo $this->Lang['PREVIEW']; ?>" target="_blank"></a>
                    </td>
                    <?php /* if(($this->uri->last_segment() == 'manage-products.html')||($this->uri->segment(2) == 'manage-products.html')){ ?> 
                    <td align="left">
                  ...
                  <?php } */ ?>
					<td><?php if($u->product_duration !="") { ?>
						...
						<?php } ?></td>
                    <td align="left"><a href="<?php echo PATH.'store-admin/view-products/'.$u->deal_key.'/'.$u->deal_id.'.html';?>"><?php echo $this->Lang["VIEW_DET"]; ?></a></td>
                </tr>
            <?php $i++;} ?>   
        </table>
        </div>
