...
<form action=""  method="post" class="admin_form" name="newsletter">
			 <div class="input-text1 clearfix">
    			...
    			<div class="search-input1 select-box"> 
    				<select name="users"  class="select" onchange="return user_change(this.value,3);" autofocus >
          ...
          <div class="input-text1 clearfix">
             ...
             <label>  &nbsp;</label>
              <div class="search-input1"> 
                ...
                <input type="button" value="<?php echo $this->Lang['CANCEL']; ?>" onclick="window.location.href='<?php echo PATH.$this->url;?>'"/>  
                </div>
                </div>

                <?php if(isset($this->mer_auction_act)) { foreach( $this->deatils as $u) { // for auction details ?>
