...
<div class="bread_crumb"><a href="<?php echo PATH."store-admin.html"; ?>" title="Home"><?php echo $this->Lang["HOME"]; ?> <span class="fwn">&#155;&#155;</span></a><p><?php echo $this->template->title; ?></p></div>
        ...
        if (input.files && input.files[0]) {
            ...
            reader.readAsDataURL(input.files[0]);
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td><input type="submit" value="<?php echo $this->Lang['SUBMIT']; ?>" id="check2"/><input type="button" value="<?php echo $this->Lang['CANCEL']; ?>" onclick='window.location.href="<?php echo PATH?>store-admin/manage-auction.html"'/></td>
                </tr>
            </table><?php }?>
        </form>
