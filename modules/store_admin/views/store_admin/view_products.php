    ...
    <div class="content_middle">
      ...
      <fieldset>
		...
		<?php } ?>
                ...
                <tr>
                        <th align="left" ><?php echo $this->Lang["PRODUCT_PRI"]; ?></th><th>:</th><td align="left"><?php echo $symbol." ".$d->deal_price; ?></td>
                </tr>
		<tr>
      ...
      <fieldset>
    		<legend> <?php echo $this->Lang['TRANS_DET']; ?></legend>
                ...
                <tr><td colspan="3">
                 <?php echo new View("store_admin/product_transaction_list"); ?>      </td>
                </tr> 
				</table> 
				<table class="list_table fl clr show_details_table">
              
                <tr><td colspan="3">
                 <?php echo new View("store_admin/cod_transaction_list"); ?>      </td>
                </tr> 
				</table> 
