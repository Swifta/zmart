        ...
        <?php foreach($this->deal as $u){?>
            <table>
                <tr>
                    ...
                    <td><label>:</label></td>
                    <td>
                    	<input autofocus type="text" maxlength="255" name="title" value="<?php echo $u->deal_title; ?>" />
			...
			<?php $cat_ids = explode(',',$u->third_category_id); $i = 1; foreach($this->third_category_list as $d){ if($u->sec_category_id == $d->sub_category_id) { ?>
				...
				<?php } else{ if($i == 1){ ?>
                    ...
                    <td>
                        <input type="hidden" name="deal_type" value="1" <?php if($u->deal_type == 1){ ?>checked="checked" <?php } ?>/> 
...
<em><?php if(isset($this->form_error["description"])){ echo $this->form_error["description"]; }?></em>
		 ...
		 <tr>
                    ...
                    <td>
                        <select name="stores">
                        <option value="" <?php if($u->shop_id==0){ ?>selected="selected" <?php } ?>><?php echo $this->Lang["SEL_MERCHANT_FIRST"]; ?></option>
							...
							<div class="uploadWrapper">
                                                        ...
                                                        <input type="file" name="image[]"  class="first" id="first<?php echo '_'.$i;?>" onchange="return validateFileExtension1(this,<?php echo $i;?>)"  style="width:24px;"  title="<?php echo $this->Lang['EDIT']; ?>"/>                                                        
                                                            ...
                                                            <?php  if(file_exists(DOCROOT.'images/deals/1000_800/'.$u->deal_key.'_'.$i.'.png'))  { ?>
                                                                                                                       ...
                                                                                                                       <a class="image_delete" href="<?php echo PATH; ?>delete-images.html?id=<?php echo $u->deal_id; ?>&img=<?php echo base64_encode($u->deal_key.'_'.$i);?>&deal_key=<?php echo $u->deal_key; ?>" onclick="return confirm('<?php echo $this->Lang["ARE_U_DEL"]; ?>')" title="<?php echo $this->Lang['DELETE']; ?>">
 ...
 <img id="del<?php echo '_'.$i;?>" border="0" src= "<?php echo PATH.'resize.php';?>?src=<?php echo PATH.'images/deals/1000_800/'.$u->deal_key.'_'.$i.'.png';?>&w=100&h=125" alt="" class="class_img<?php echo $i;?>"/>
                        <?php /* <img id="del<?php echo '_'.$i;?>" border="0" src= "<?php echo PATH.'images/deals/466_347/'.$u->deal_key.'_'.$i.'.png';?>" alt="" width="100" /> */ ?>
                <?php } else {  ?>
        ...
        if (input.files && input.files[0]) {
            ...
            reader.readAsDataURL(input.files[0]);
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td><input type="submit" value="<?php echo $this->Lang['SUBMIT']; ?>" id="check2"/><input type="button" value="<?php echo $this->Lang['CANCEL']; ?>" onclick="window.location.href='<?php echo PATH?>admin/manage-deals.html'"/></td>
                </tr>
            </table><?php }?>
        </form>
