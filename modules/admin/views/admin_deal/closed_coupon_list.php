...
<form method="get" class="admin_form fl" action="">
	...
	<?php if(count($this->all_coupon_list) > 0){ ?>
		<?php if($this->pagination !=""){ ?>
				<a class="fr frm_export" href="<?php echo PATH.'admin/close-couopn-list.html/page/'.$this->page.'?id='.$this->Lang['SEARCH'].'&coupon_code='.$this->input->get('coupon_code').'&name='.$this->input->get('name');  ?>" title="<?php echo $this->Lang['EXP_DL']; ?>"><?php echo $this->Lang['EXP_PAGE']; ?></a>
			<?php } ?>
			
		<a class="fr frm_export" href="<?php echo PATH.'admin/close-couopn-list.html?id='.$this->Lang['ALL2'].'&coupon_code='.$this->input->get('coupon_code').'&name='.$this->input->get('name');  ?>" title="<?php echo $this->Lang['EXP_ALL']; ?>"><?php echo $this->Lang['EXP_ALL']; ?></a>
	            ...
	            if(isset($this->search_key)){
                    ...
                    <div class="list_table1 fl clr date_range_part">
                        ...
                        <div class="date_range_lft">
                            ...
                            <span><input type = "text" autofocus name ="coupon_code" <?php if(isset($s->name)){?> value="<?php echo $s->coupon_code; ?>"<?php } ?>/></span>
                        </div>
