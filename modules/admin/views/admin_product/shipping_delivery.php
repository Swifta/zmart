...
<div class="cont_container mt15 mt10" >
    ...
    <div class="content_middle">
	 ...
	 <?php if($this->pagination !=""){ ?>
				<a class="fr frm_export" href="<?php echo PATH.'admin/shipping-delivery.html/page/'.$this->page.'?id='.$this->Lang['SEARCH'].'&search='.$this->input->get('search'); ?>"  title="<?php echo $this->Lang['EXP_DL']; ?>"><?php echo $this->Lang['EXP_PAGE']; ?></a>
			<?php } ?>

				<a class="fr frm_export" href="<?php echo PATH.'admin/shipping-delivery.html?id='.$this->Lang['ALL2'].'&search='.$this->input->get('search'); ?>" title="<?php echo $this->Lang['EXP_ALL']; ?>"><?php echo $this->Lang['EXP_ALL']; ?></a>
	<?php } ?>
                <?php 
            ...
            <tr>
            <td></td><td></td><td>
           	 <label><?php echo $this->Lang['NAME'].",".$this->Lang['EMAIL'].",".$this->Lang['COUPON_CODE']; ?></label>
            </td>
            </tr>
        </table>
        </form>
    ...
    <?php if(count($this->shipping_list)>0){?>
        <table class="list_table fl clr mt15">
			...
			<th align="left" ><?php echo $this->Lang['ADDRES']; ?></th> 
			 <th align="left" ><?php echo 'Aramex'; ?></th> **/?>
		...
		<?php /*<th align="left" ><?php echo $this->Lang["DELETE"]; ?></th> */ ?>
            ...
            <?php $i=0; $first_item = $this->pagination->current_first_item;
                ...
                <tr>
						...
						<td align="left"><?php echo date('d-M-Y h:i:s A',$u->shipping_date); ?></td>
			...
			<td align="center">
			<?php if($u->tracking == '') { ?>
			<a href="<?php echo PATH.'admin_products/Aramex_request/'.$u->shipping_id;?>"><img  height="16" width="16" src="<?php echo PATH;?>/images/ship.png"/></a>
			<?php }else { ?>
			<img src="<?php echo PATH;?>/images/done.png"/>
			<?php } ?>
			</td>  **/?>
						...
						<div style="margin-top: 20px; width:99%;">
							<div style="float:left; margin-top: 20px;"></div>
								<div style="float:left; width: 40%; font-size:12px; border-right: 1px dotted #666666; margin-left: 10px;">
										...
										<strong style="font-size: 15px; margin:0; padding:0;"><?php echo $this->Lang['AMTPAID']; ?>: <?php echo CURRENCY_SYMBOL.(($u->deal_value * $u->quantity) + ($u->shipping) + ($u->tax_amount)); ?></strong><br>
	...
	<form method="post"  class="admin_form" id="form">
			...
			<tr>
                    ...
                    <td align="left">
						...
						<?php } else { ?>
							<select  onchange="return product_shipping_delivery('<?php echo $u->email; ?>','<?php echo $u->firstname; ?>','<?php echo $u->shipping_id; ?>',this.value)">
							...
							<?php } ?>
							<?php }else{
                                                            if($u->delivery_status==0){
								echo $this->Lang['PENDING'];
							    }else if($u->delivery_status==1){
								echo $this->Lang['ORDER_PACKED'];
							    }else if($u->delivery_status==2){
								echo $this->Lang['SHIPPED_DELI_CENT'];
							    }else if($u->delivery_status==3){
								echo $this->Lang['OR_OUT_DELI'];
							    }else{
								echo $this->Lang['DELIVERED'];
							    }
