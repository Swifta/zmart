    ...
    <div class="content_middle">
       ...
       <td> <label><?php echo $this->Lang["GENDER"]; ?></label><span></span></td>
                  ...
                  <tr <?php if(!isset($this->form_error['all_users']) && isset($this->userPost['all_users'])){?><?php }else{?>class="user_filters"<?php }?> >
                        ...
                        <td id="email1">
							<div class="input-text1 clearfix">
							 ...
							 <li><input type="checkbox" name="email[]" class="case" value="<?php echo $users->email.'__'.$users->firstname;?>" <?php if(isset($_POST['email'])){  if(in_array($users->email.'__'.$users->firstname,$_POST['email'])){?>checked<?php } } ?> /><span><?php echo $users->email;?></span></li>
							 <?php } ?>
							 <?php } ?>
							 </ul></div></div></div></td>
                 ...
                 <tr>
                        ...
                        <td><label>:</label></td>
                        <td><input type="text" name="title"  value="<?php if(!isset($this->form_error['title']) && isset($this->userPost['title'])){ echo $this->userPost['title']; }?>" />
                        <em><?php if(isset($this->form_error["title"])){ echo $this->form_error["title"]; }?></em></td>
                 </tr>
                  <tr>
                        <td><label><?php echo $this->Lang["FOOTER_CONTENT"]; ?></label><span>*</span></td>
                        <td><label>:</label></td>
                        <td><input type="text" name="footer"  value="<?php if(!isset($this->form_error['footer']) && isset($this->userPost['footer'])){ echo $this->userPost['footer']; }?>" />
                        <em><?php if(isset($this->form_error["footer"])){ echo $this->form_error["footer"]; }?></em></td>
                 </tr>
                 <tr>
...
$(document).ready(function() {
	...
	var url = SrcPath+'/newsletter/user_select1/1/'+city+'/'+gender+'/'+age_range; 
