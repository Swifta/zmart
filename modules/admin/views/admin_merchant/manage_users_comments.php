...
<div class="cont_container mt15 mt10">
    ...
    <div class="content_middle">
        <form method="get" class="admin_form" action="<?php echo PATH.'admin/manage-store-comments.html';?>">
            <table class="list_table1 fl clr">
		     ...
		     <tr>
		     <td></td><td></td><td>
		    <label><?php echo $this->Lang['USER_NAME']; ?>, <?php echo 'Store Name'; ?>, <?php echo $this->Lang['COMM_DESCC']; ?></label>
		    </td>
             </tr>
        </table>
        </form>
        ...
        <table class="list_table fl clr mt15">
            ...
            <?php $i=0; $first_item = $this->pagination->current_first_item;
                ...
                <tr>    
                        ...
                        <td align="left"><a href="<?php echo PATH; ?>admin/merchant-details/<?php echo base64_encode($u->merchant_id); ?>.html" title="$u->store_name" ><?php echo ucfirst($u->store_name); ?></a></td>
                    ...
                    <td align="left">
                    	<a href="<?php echo PATH.'admin/edit-store-comments/'.$u->discussion_id;?>.html" class="editicon" title="<?php echo $this->Lang['EDIT_COMM']; ?>"></a>
                        </td>
                        <td>
                    	<?php if($u->discussion_status == 1){?>
                    	<a href="<?php echo PATH.'admin/block-store-comments/'.$u->discussion_id.'.html'?>" class="blockicon" title="<?php echo $this->Lang['BLOCK_COMM']; ?>"></a>
                        <?php } else{  ?>
                        <a href="<?php echo PATH.'admin/unblock-store-comments/'.$u->discussion_id.'.html'?>" class="unblockicon" title="<?php echo $this->Lang['UNBLOCK_COMM']; ?>"></a>
                        <?php } ?>
                    </td>
		 			<td>
                    	<a onclick="return deleteStoreComments('<?php echo $u->discussion_id; ?>')" class="deleteicon" title="<?php echo $this->Lang['DELETE']; ?>" ></a>
                    </td>  
