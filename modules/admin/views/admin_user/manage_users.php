...
<div class="cont_container mt15 mt10">
    ...
    <div class="content_middle">
        <form method="get" class="admin_form" action="<?php echo PATH.'admin/manage-user.html';?>">
                <?php $this->session->set("lasturl",substr($_SERVER['REQUEST_URI'], REQUEST_URL_COUNT));  ?>
                <?php if(($this->uri->last_segment()=="manage-user.html") || ($this->uri->segment(3)=="page")) { ?>	
    ...
    <?php if(count($this->users_list)>0){?>
        ...
        <table class="list_table fl clr mt15">
        	<tr>
            	...
            	<?php if(ADMIN_PRIVILEGES_CUSTOMER_EDIT){?>
            ...
            <?php $i=0; $first_item = $this->pagination->current_first_item;
                ...
                <tr>
                        ...
                        <td align="left"><a href="<?php echo PATH.'admin/view-user/'.$u->user_id;?>.html"><?php echo ucfirst(htmlspecialchars($u->firstname)); ?></a></td>
                ...
                <table>
		            ...
		            <td><textarea class="TextArea" name="message" id="msg" cols=15 rows=10 /></textarea>
                        ...
                        <tr>
                             <td></td>
                             <td></td>
                             <td><input type="submit" value="<?php echo $this->Lang['SEND']; ?>" id="submit<?php echo $u->user_id; ?>"> <input type="reset" id="cancel" value="<?php echo $this->Lang['CANCEL']; ?>" onclick="javascript:window.location='<?php echo PATH; ?>admin/manage-user.html'" />
			     </td>
                        </tr>
                </table>
        </form>
                    ...
                    <?php if(ADMIN_PRIVILEGES_CUSTOMER_EDIT){?>
                        <td align="left">
							<a href="<?php echo PATH.'admin/edit-user/'.$u->user_id;?>.html" class="editicon" title="<?php echo $this->Lang['EDIT_USER']; ?>"></a>
                        </td>
                       <?php }?>
                       <?php if(ADMIN_PRIVILEGES_CUSTOMER_BLOCK){?>
                    <td>
						<?php if($u->user_status == 1){?>
                    	<a onclick="return blockunblockUser('<?php echo $u->user_id; ?>','<?php echo base64_encode($u->email); ?>','block');" class="blockicon" title="<?php echo $this->Lang['BLO_USER']; ?>"></a>
                        <?php } else{  ?>
                        <a onclick="return blockunblockUser('<?php echo $u->user_id; ?>','<?php echo base64_encode($u->email); ?>','unblock');" class="unblockicon" title="<?php echo $this->Lang['UNBLO_USER']; ?>"></a>
                        <?php } ?>
                    </td>
                    <td>
						<a onclick="return deleteUser('<?php echo $u->user_id; ?>','<?php echo base64_encode($u->email); ?>');" class="deleteicon" title="<?php echo $this->Lang['DEL_USER']; ?>" ></a>
                    </td>
                    <?php }?>
