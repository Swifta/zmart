    ...
    <div class="invest-cl">
      <div class="invest-cr">
        <div class="inves_marketing">
          <h3 class="market"><?php echo $this->Lang['WEB_CUS_DET']; ?></h3>
          <div class="invest-cl">
            <div class="invest-cr">
              <div class="invest-cm">
                    ...
                    <div class="invest-tl">
                      ...
                      <div class="trans_table_mid_tot">
                        ...
                        <div class="trans_table_mm_tot" >
                          <h3 class="market"><?php echo $this->Lang['USER_DET']; ?></h3>
            ...
            <tr>
            <td><a href="<?php  echo PATH; ?>admin/manage-user.html?name=&amp;email=&amp;city=&amp;logintype=1"><?php echo $this->Lang['WEB_CUS']; ?></a> </td>
            <td><?php echo abs($y-$admin_user-$facebook_user); ?> </td>
            </tr>
            <tr>
            <td><a href="<?php  echo PATH; ?>admin/manage-user.html?name=&amp;email=&amp;city=&amp;logintype=2"><?php echo $this->Lang['ADMIN_USER']; ?></a>  </td>
            <td><?php echo $admin_user; ?></td>
            </tr>
            <tr>
            <td><a href="<?php  echo PATH; ?>admin/manage-user.html?name=&amp;email=&amp;city=&amp;logintype=3"><?php echo $this->Lang['FACEBOOK_USER']; ?></a> </td>
            <td><?php echo $facebook_user; ?></td>
            </tr>
            <tr>
            <td><a href="<?php  echo PATH; ?>admin/manage-user.html"><?php echo $this->Lang['TOT_CUS']; ?></a></td>
            <td><?php echo $y; ?></td>
            </tr>
            </table>
                        </div>
		...
		<div class="trans_table_mid_tot">
                        <div class="trans_table_ml_tot"> </div>
                        <div class="trans_table_mm_tot" >
                          <h3 class="market"><?php echo $this->Lang['CUS_LGN_DET']; ?></h3>
            <table width="100%" cellpadding="10" cellspacing="0">
            <tr>
            <th align="left"><?php echo $this->Lang['WEB_CUS']; ?> </th>
            <th align="left"><?php echo $this->Lang['COUNT']; ?> </th>
            </tr>
            <tr>
            ...
            <td><?php echo $tj; ?> </td>
             ...
             <tr>
            <td><?php echo $this->Lang['LST_SEVEN_DAYS']; ?></td>
            <td><?php echo $wj; ?> </td>
            </tr>
            <tr>
