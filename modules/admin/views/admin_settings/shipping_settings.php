                        ...
                        <div class="mergent_det">
	                        <fieldset>
                            	<legend><?php echo $this->Lang["ARAMAX_ACC"]; ?></legend>   
			                        <table>
		                                <tr>
                                            <td style="width: 200px;"><label><?php echo $this->Lang['ACCOUNTCOUNTRYCODE']; ?></label><span>*</span></td>
                                            <td><label>:</label></td>
		                                ...
		                                <tr>
                                            <td style="width: 200px;"><label><?php echo $this->Lang['ACCOUNTENTITY']; ?></label><span>*</span></td>
                                            <td><label>:</label></td>
		                                ...
		                                <tr>
                                            <td style="width: 200px;"><label><?php echo $this->Lang['ACCOUNTNUMBER']; ?></label><span>*</span></td>
                                            <td><label>:</label></td>
                                        ...
                                        <tr>
                                            <td style="width: 200px;"><label><?php echo $this->Lang['ACCOUNTPIN']; ?></label><span>*</span></td>
                                            <td><label>:</label></td>
                                        ...
                                        <tr>
                                            <td style="width: 200px;"><label><?php echo $this->Lang['USERNAME']; ?></label><span>*</span></td>
                                            <td><label>:</label></td>
                                        ...
                                        <tr>
                                            <td style="width: 200px;"><label><?php echo $this->Lang['PASSWORD']; ?></label><span>*</span></td>
                                            <td><label>:</label></td>
