    ...
    <div class="content_middle">
     <div class="settings_menu">
        <ul>
            ...
            <li><a href="<?php echo PATH.'admin/Edit_info.html'; ?>"><?php echo $this->Lang["EDIT_INFO"]; ?> </a></li><li>|</li>
            <?php } ?>
            <li><a href="<?php echo PATH.'admin/change_password.html'; ?>"><?php echo $this->Lang["CHANGE_PASS"]; ?></a></li>
        </ul>
    </div>
