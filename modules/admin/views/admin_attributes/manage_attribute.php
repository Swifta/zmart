		...
		<?php if(ADMIN_PRIVILEGES_SPECIFICATION_EDIT){?>
            ...
            <?php   $i=0; $first_item = $this->pagination->current_first_item; 
                ...
                <tr>
                    ...
                    <?php if(ADMIN_PRIVILEGES_SPECIFICATION_EDIT){?>
                    <td>
						<a href="<?php echo PATH.'admin/edit-attribute/'.base64_encode($c->attribute_id).'.html'; ?>" class="editicon" title="<?php echo $this->Lang['EDIT_ATTR']; ?>"></a>
                    </td>
                   <?php }?>
                   <?php if(ADMIN_PRIVILEGES_SPECIFICATION_BLOCK){?>
                    <td>
						<a href="<?php echo PATH.'admin/delete-attribute/'.base64_encode($c->attribute_id);?>.html" onclick="return confirm('<?php echo addslashes($this->Lang['ATTR_DELETE']); ?>')" class="deleteicon" title="<?php echo $this->Lang['ATTR_DELETE']; ?>"></a>
                    </td>
                    <?php }?>
                </tr>
            <?php $i++; } ?>    
