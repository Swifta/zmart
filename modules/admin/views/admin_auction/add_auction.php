        ...
        <form action="" method="post" class="admin_form" enctype="multipart/form-data">
            <table>
                ...
                <tr>
                    ...
                    <td><label>:</label></td>
                    <td>
                    	<select name="category" onchange="return change_auction_category(this.value);">
			...
			<?php } else{ ?>
                ...
                <tr id="sec_category">
                    ...
                    <td >
                        ...
                        <select name="third_category"    onchange="return third_change_auction_category(this.value);">
		 ...
		 <tr>
                ...
                <tr>
                    ...
                    <?php foreach($this->get_marchant_list as $d){ ?> 
                        <option value="<?php echo $d->user_id ?>"><?php echo $d->firstname; ?></option>
                          <?php } ?>
                        </select>
		 ...
		 <input type="radio" name="autopost" <?php if($this->session->get("facebook_status")==1) {?> checked <?php } ?>  value="1" > Yes <input type="radio" name="autopost" value="2"> No
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td><input type="submit" id="submit" value="<?php echo $this->Lang['SUBMIT']; ?>" /><input type="button" value="<?php echo $this->Lang['RESET']; ?>" onclick="javascript:window.location='<?php echo PATH; ?>admin/add-auction.html'"/></td>
                </tr>
            </table>
        </form>
