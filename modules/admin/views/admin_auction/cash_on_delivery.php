...
<div class="cont_container mt15 mt10" >
	...
	<?php /* <th align="left" ><?php echo $this->Lang['ADDRES']; ?></th> */ ?>
		...
		<?php /*	
			...
			<div class="popup_show1 popup_show_act" id="lightboxdetails-panel<?php echo $u->shipping_id; ?>" style="display:none;"  >
						...
						<div style="margin-top: 20px; width:99%;">
							<div style="float:left; margin-top: 20px;"></div>
								<div style="float:left; width: 40%; font-size:12px; border-right: 1px dotted #666666; margin-left: 10px;">
										...
										<strong style="font-size: 15px; margin:0; padding:0;"><?php echo $this->Lang['AMO_TO_B_PAID']; ?>: <?php echo CURRENCY_SYMBOL.(($u->bid_amount * $u->quantity) + ($u->shipping) + ($u->tax_amount)); ?></strong><br>
										<span class="caption"><?php echo $this->Lang['INCLU_ALL_CH']; ?></span><br><br>
										<strong style="font-size: 15px; margin:0; padding:0;"><?php echo $this->Lang['OR_DATE']; ?>: <?php echo date("d-M-Y h:i:s A",$u->transaction_date); ?></strong><br>
											<br>
...
$('#em').text(''); 
                    ...
                    <td align="center">
						...
						<select  onchange="return auction_cod_delivery('<?php echo $u->email; ?>','<?php echo $u->firstname; ?>','<?php echo $u->shipping_id; ?>',this.value,'0','<?php echo $u->auction_id; ?>','<?php echo $u->trans_id; ?>','<?php echo $u->merchant_id; ?>')">
