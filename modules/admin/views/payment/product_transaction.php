...
<div class="cont_container mt15 mt10">
                 ...
                 <div class="list_table1 fl clr date_range_part">
                  <div class="date_range_lft">
                   ...
                   <div class="date_range_right">
                        ...
                        <span><select onchange="window.open(this.options[this.selectedIndex].value,'_top')" autofocus>
		        
		        <option value="<?php echo PATH.'admin-product/all-transaction.html';?>" <?php if($this->uri->last_segment() == "all-transaction.html"){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["ALL_TRAN"]; ?></option>

		        <?php /* <option value="<?php echo PATH.'admin-product/success-transaction.html';?>" <?php if(($this->uri->last_segment() == "success-transaction.html")||($this->uri->segment(2)== "success-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["SUCC_TRAN"]; ?></option> */ ?>
		        
		        <option value="<?php echo PATH.'admin-product/completed-transaction.html';?>" <?php if(($this->uri->last_segment() == "completed-transaction.html")||($this->uri->segment(2)== "completed-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["COMP_TRAN"]; ?></option>
		        
		        <option value="<?php echo PATH.'admin-product/failed-transaction.html';?>" <?php if(($this->uri->last_segment() == "failed-transaction.html")||($this->uri->segment(2)== "failed-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["FAI_TRAN"]; ?></option>
		        
		        <option value="<?php echo PATH.'admin-product/hold-transaction.html';?>" <?php if(($this->uri->last_segment() == "hold-transaction.html")||($this->uri->segment(2)== "hold-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["HOLD_TRAN"]; ?></option>         
		        </select></span>
                 </div>
                 </div>
                <div class="list_table1 fl clr date_range_part">
	...
	<?php echo new View("payment/product_transaction_list"); ?>
    </div>
