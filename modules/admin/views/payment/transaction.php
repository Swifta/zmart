...
<div class="cont_container mt15 mt10">
            ...
            <div class="date_range_right">
             ...
             <?php if(isset($this->search_key)){        
              ...
              <div class="list_table1 fl clr date_range_part">
		        ...
		        <option value="<?php echo PATH.'admin/all-transaction.html';?>" <?php if($this->uri->last_segment() == "all-transaction.html"){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["ALL_TRAN"]; ?></option>
		         
		        <option value="<?php echo PATH.'admin/success-transaction.html';?>" <?php if(($this->uri->last_segment() == "success-transaction.html")||($this->uri->segment(2)== "success-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["SUCC_TRAN"]; ?></option>
		        
		        <option value="<?php echo PATH.'admin/completed-transaction.html';?>" <?php if(($this->uri->last_segment() == "completed-transaction.html")||($this->uri->segment(2)== "completed-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["COMP_TRAN"]; ?></option>
		        
		        <option value="<?php echo PATH.'admin/failed-transaction.html';?>" <?php if(($this->uri->last_segment() == "failed-transaction.html")||($this->uri->segment(2)== "failed-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["FAI_TRAN"]; ?></option>
		        
		        <option value="<?php echo PATH.'admin/hold-transaction.html';?>" <?php if(($this->uri->last_segment() == "hold-transaction.html")||($this->uri->segment(2)== "hold-transaction")){  ?>  selected="selected" <?php }  ?>><?php echo $this->Lang["HOLD_TRAN"]; ?></option>         
		        </select></span>
                  </div>                  
              </div>
             <div class="list_table1 fl clr date_range_part">
                <div class="date_range_right">
                    <label>&nbsp;</label>        
                    <span>(<?php echo $this->Lang["SEARCH_TRAN"]; ?>)</span>
                </div>                    
            </div>
	...
	<?php echo new View("payment/transaction_list"); ?>
    </div>
