                ...
                <div class="contianer">
					<div class="bread_crumb">
                        <ul>
                            ...
                            <li><p><?php echo $this->Lang['PAY_PENDING']; ?></p></li>
                        </ul>
                    </div>
                    ...
                    <div class="payouter_block pay_br">
                        <!--Blog content starts-->                        
                            <h3 class="paybr_title pay_titlebg"><?php echo $this->Lang['PAY_PENDING']; ?>                            
                            </h3>
                            <div class="p_inner_block clearfix">
                                ...
                                <div class="payment_sucess_common">
                                    <div class="payment_sucss_lft">                                        
                                        <a href="#" title="<?php echo $this->Lang['PAY_PENDING']; ?>">
                                    ...
                                    <div class="payment_sucss_rgt">
                                        ...
                                        <div class="payment_suc_content">
                                            ...
                                            <h2><?php echo $this->Lang["YOUR_PAYMENT_PENDING"]; if(isset($this->is_store_credit)) {  echo " and ".$this->Lang["YOUR_MER_APPR"]; } ?></h2>
											<?php $R = $this->result; ?>
                                            <ul>                                                
                                                                                                <?php if(isset($R->T_ID)){ ?>
