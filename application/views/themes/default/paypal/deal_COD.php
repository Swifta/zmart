...
<form name="payment" method="POST" id="commentForm_cod" action="<?php echo PATH;?>paypal/deal_cash_delivery">
  <input name="P_QTY" id="COD_QTY_VAL" value="1" type="hidden" >
  ...
  <input name="amount" id="COD_AMOUNT"  type="hidden" value="<?php echo $payment->deal_value; ?>" >
