...
<form name="payment" method="POST" id="commentForm_deals" action="<?php echo PATH;?>auction_paypal/dodirectpayment">
 ...
 <div class="hideerror" id="city_validation">This Field Is Required.</div>    
										...
										<li>
												...
												<div class="fullname"><input tabindex="18" id="ship_phone1" name="shipping_phone" size="40" AUTOCOMPLETE="OFF"  placeholder="<?php echo $this->Lang['ENTER_PHONE']; ?>" type="text" value="" class="required number" maxlength="18"/></div>
										</li>
