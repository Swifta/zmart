...
<?php foreach ($this->deals_payment_deatils as $payment) { ?>
    <form name="payment" method="POST" id="commentForm_deals" action="<?php echo PATH; ?>payment/creditcard.php">
        <input name="P_QTY" id="PCC_QTY_VAL" value="1" type="hidden" >
        ...
        <input name="amount" id="PCC_AMOUNT"  type="hidden" value="<?php echo $payment->deal_value; ?>" >
        <input name="p_referral_amount" id="PCC_REFERRAL" value="0" type="hidden">
            ...
            <div class="payment_form_section">
				...
				placeholder="<?php echo $this->Lang['ENTER_FRI_NAME']; ?>" autofocus /></div>
                        ...
                        <li>
                            ...
                            <div class="fullname"><input type="text" value="" AUTOCOMPLETE="OFF"  name="friend_email" class="required"
                ...
                <div class="payment_form">
                    <ul>
                        <li>
                            ...
                            <div class="fullname"><input type="text" value="" tabindex="1" maxlength="50" name="firstName" AUTOCOMPLETE="OFF"  class="required" 				placeholder="<?php echo $this->Lang['ENTER_CAR_HOLDER']; ?>"/></div>
                            <em>
                        ...
                        <li>
                            ...
                            <div class="security_code_outer">
                                <div class="security_code">
                                    <input type="password" tabindex="5"  maxlength="4" name="cvv2Number" AUTOCOMPLETE="OFF"  class="required number"
                ...
                <div class="payment_form">
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="fullname"><input type="text" tabindex="7" maxlength="40" name="city" AUTOCOMPLETE="OFF"  class="required"
    ...
    <?php if (isset($this->form_error['state'])) {
        echo $this->form_error["state"];
                        ...
                        <li>
                            ...
                            <div class="fullname"><input type="text" tabindex="9" AUTOCOMPLETE="OFF"  maxlength="10" name="zip" class="required number" placeholder="<?php echo $this->Lang['ENTER_POSTAL_CODE']; ?>" /></div>
                            <em>
...
<?php if(count($this->cms_tc) > 0){ ?>
            <div class="payment_terms_outer"><p class="terms-conditons-text" style="padding-left:0px;"> <span class="fl font_myriad_pro"><?php echo $this->Lang['BY_CLICK']; ?> </span> <a onclick="show_dis_tc();" title="<?php echo $this->Lang['TEMRS']; ?>" class="font_myriad_pro mt5" tabindex="11"><?php echo $this->Lang['TEMRS']; ?>.</a></p> </div>
            <?php } ?>
        </div>
