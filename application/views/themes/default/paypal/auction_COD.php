...
<form name="payment" method="POST" id="commentForm_cod" action="<?php echo PATH;?>auction_paypal/cash_on_delivery">
                                    ...
                                    <ul>
                                       ...
                                       <li>
										...
										<li>
												...
												<div class="fullname"><input tabindex="9" id="ship_phone_cod1" name="phone" size="40" AUTOCOMPLETE="OFF"  placeholder="<?php echo $this->Lang['ENTER_PHONE']; ?>" type="text" value="" class="required number" maxlength="18"/></div>
										</li>
