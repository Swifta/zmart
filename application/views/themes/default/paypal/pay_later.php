...
<script>
  ...
  <form name="payment" method="POST" id="commentForm" action="<?php echo PATH;?>pay_later/product_payment">  
    ...
    <?php if (isset($this->form_error['friend_email'])) {
        ...
        <div class="payment_form_block clearfix">
            ...
            <input name="p_referral_amount" id="COD_REFERRAL" value="0" type="hidden" >
                <?php } ?>
                <input name="prime_customer" id="PL_PRIME_CUSTOMER" value="<?php echo $this->session->get('prime_customer');?>" type="hidden" >
