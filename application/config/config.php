...
(
	...
	MODPATH.'deals',            // Deals Panel Modules
	MODPATH.'products',      // Products Panel Modules
	MODPATH.'auctions',      // Auctions Panel Modules
	MODPATH.'soldout',      // Soldout Panel Modules
	MODPATH.'stores',        // Stores Panel Modules
	MODPATH.'users',        // Users Panel Modules
	MODPATH.'seller_registration',        // Seller Registration Modules
	MODPATH.'payment_gateway',       // All payment gateway modules  
	MODPATH.'shipping_gateway',     // All shipping gateway modules  
	MODPATH.'plugins',     // All plugins modules
	MODPATH.'fashion1',     // All plugins modules

);
*/

// Get the all folder from the modules directory //

$dirs = array_filter(glob('modules/*'), 'is_dir');

$config['modules'] = array();

$modules_path = str_replace('/modules','',MODPATH);

$modules_string = '';

foreach($dirs as $value)
{
	$config['modules'][] = $modules_path.$value; 
}
